  ...
  <div class="iter-container">
    ...
    <div class="test-area">
      ...
      <div class="test-result">
        <NFlex justify="center" v-if="waitingTestResult" class="animation-wrapper">
          <Vue3Lottie :animationData="javaIcon" :height="180" :width="180" style="margin: 0" />
          <div style="width: 100%; text-align: center">正在等待评测结果...</div>
        </NFlex>
